...
#[allow(dead_code)]
pub const RUSTC: &str = r"/home/sergio/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub const RUSTDOC: &str = r"/home/sergio/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc";
...
#[doc=r#"The output of `/home/sergio/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustc -V`"#]
#[allow(dead_code)]
pub const RUSTC_VERSION: &str = r"rustc 1.81.0 (eeb90cda1 2024-09-04)";
#[doc=r#"The output of `/home/sergio/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc -V`; empty string if `/home/sergio/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
